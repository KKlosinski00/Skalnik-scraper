...
def get_html(url, **kwargs):
    ...
    if kwargs.get("page"):  
        resp = httpx.get(url + str(kwargs.get("page")), headers=headers, follow_redirects=True,timeout=60.0)
    else:
...
def append_to_csv(products):
    ...
    with open("Odziez_turystyczna_damska.csv", "a", encoding="utf-8") as f:
...
def main():
    products = []
    baseurl = "https://www.skalnik.pl/odziez/odziez-damska/page:"
    for x in range(1,20):
